use constants::vga::{BUFFER_HEIGHT, BUFFER_WIDTH};
...
pub static VGA: Mutex<VGA> = Mutex::new(VGA {frame: unsafe { Unique::new_unchecked(0xb8000 as *mut _) } }); //Our interface to the VGA buffer
